            ...
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-info">
                    ...
                    <span class="user-detail">
                        ...
                        <span class="user-role">@if(Auth::user()){{ Auth::user()->roles->first()->name ?? 'Staff' }}@endif</span>
                    </span>
                </span>
            </a>
                ...
                <div class="profilename">
                    <div class="profileset">
                        ...
                        <div class="profilesets">
                            ...
                            <h5>@if(Auth::user()){{ Auth::user()->roles->first()->name ?? 'Staff' }}@endif</h5>
                        </div>
                    </div>
                    <hr class="m-0">
                    <a class="dropdown-item" href="{{ url('profile') }}"><i class="me-2" data-feather="user"></i> My Profile</a>
                    <a class="dropdown-item" href="{{ route('settings.index') }}"><i class="me-2" data-feather="settings"></i>Settings</a>
                    <hr class="m-0">
                    <form action="{{ route('logout') }}" method="POST" style="display:inline;">
                        @csrf
                        <button type="submit" class="dropdown-item logout pb-0" style="border:none; background:none; width:100%; text-align:left;">
